  ...
  return (
    <div className="flex h-screen bg-[#F3F4F6] text-slate-800 font-sans overflow-hidden">
      ...
      <aside className={`fixed inset-y-0 left-0 w-64 bg-[#3B5998] text-white flex flex-col shadow-xl z-30 transform transition-transform duration-300 lg:relative lg:translate-x-0 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <div className="flex flex-col flex-1 overflow-y-auto mt-4 px-4 pb-4">
          ...
          <div className="mt-auto pt-6 border-t border-white/10">
            <button
              ...
              className="w-full flex items-center gap-3 py-3 px-4 rounded-xl text-sm font-semibold text-red-200 hover:bg-red-500/20 hover:text-red-100 transition-all duration-300 disabled:opacity-50"
            >
        ...
        <div className="p-6 pt-0 text-[10px] text-blue-200/50 mt-auto text-center hidden lg:block">
